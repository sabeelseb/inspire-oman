...
const videos = [
  ...
  },
  {
    ...
    description: "Stories of excellence from Inspire Oman's partner community.",
    tag: "COMING SOON",
    image: "/images/gallery/handshake.jpg",
  },
];
...
const pressReleases = [
  {
    date: "Coming Soon",
    title: "Inspire Oman 2026 Officially Announced",
    excerpt: "Gulf Madhyamam and OCCI announce the prestigious Inspire Oman initiative...",
  },
  {
    date: "Coming Soon",
    title: "Arfeen Khan Confirmed as Featured Speaker",
    excerpt: "Internationally acclaimed performance strategist joins Inspire Oman...",
  },
  {
    date: "Coming Soon",
    title: "Partnership Programme Opens for Applications",
    excerpt: "Three-tier partnership programme now available for businesses...",
  },
];
    ...
    <>
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative site-container text-center">
          ...
          >
            Videos, galleries, and stories celebrating Oman&apos;s business excellence
          </motion.p>
        </div>
      </section>
      ...
      <section className="section-padding bg-primary-light relative">
        ...
        <div className="relative site-container">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {siteConfig.galleryImages.map((item, i) => (
        ...
        <div className="site-container">
          ...
          <div className="space-y-4">
            {pressReleases.map((pr, i) => (
              <ScrollReveal key={i} delay={i * 0.1}>
                <motion.div whileHover={{ x: 4 }} className="glass-card-hover p-6 flex items-start gap-4">
