  ...
  singletons: {
    ...
    site: singleton({
      ...
      schema: {
        ...
        slogan: fields.text({ label: "Default slogan" }),
        description: fields.text({ label: "Default short description", multiline: true }),
        summitDate: fields.text({ label: "Summit date" }),
        venue: fields.text({ label: "Venue" }),
        city: fields.text({ label: "City", defaultValue: "Muscat" }),
