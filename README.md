...
| `/partner` | Package comparison, sponsorship application form |
| `/media` | Videos, photo gallery, press releases |
| `/contact` | Contact info, inquiry form |

## Brand

- Primary: `#0A0A0A` (Black), `#1A1A1A` (Charcoal)
- Accent: `#C5A55A` (Gold), `#D4AF37` (Light Gold)
- Islamic geometric pattern motifs as subtle backgrounds
- Inter typeface
